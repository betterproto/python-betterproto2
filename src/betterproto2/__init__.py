...
__all__ = ["__version__", "check_compiler_version", "unwrap", "MessagePool", "default_message_pool"]
...
from betterproto2.message_pool import MessagePool, default_message_pool
